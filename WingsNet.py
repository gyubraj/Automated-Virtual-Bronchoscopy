...
class WingsNet(nn.Module):
    def __init__(self, in_channel=1, n_classes=2):
        ...
        # Output channels:
        # channel 0 = airway lumen
        # channel 1 = airway wall
        self.dc0_0 = nn.Conv3d(
            24,
            n_classes,
            kernel_size=1,
            stride=1,
...
def get_model():
    net = WingsNet(in_channel=1, n_classes=2)
    return config, net
...
if __name__ == "__main__":
    ...
    inputs = torch.randn(2, 1, 128, 128, 128, device=device)
